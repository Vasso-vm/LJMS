...
namespace Ljms\HomeBundle\Validator\Constraints;
...
class TrueValidator extends ConstraintValidator
{
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        if (!$this->container->getParameter('recaptcha.enabled')) {
            return true;
        }

        // define variable for recaptcha check answer
        $privateKey = $this->container->getParameter('recaptcha.private_key');
