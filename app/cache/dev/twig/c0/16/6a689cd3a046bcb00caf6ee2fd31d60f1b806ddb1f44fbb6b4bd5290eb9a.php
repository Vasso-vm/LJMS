...
/* LjmsAdminBundle:Schedule:add.html.twig */
class __TwigTemplate_c0166a689cd3a046bcb00caf6ee2fd31d60f1b806ddb1f44fbb6b4bd5290eb9a extends Twig_Template
{
...
\t\t\t";
        ...
        if (($this->getContext($context, "method") == "add")) {
            // line 11
            echo "\t\t\t\t<form action=\"";
            echo $this->env->getExtension('routing')->getPath("schedule_add");
            echo "\" method=\"post\" class=\"form-horizontal game_form\" id=\"add_user_form\">
\t\t\t";
        } else {
            // line 13
            echo "\t\t\t\t<form action=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("schedule_edit", array("id" => $this->getContext($context, "edit_id"))), "html", null, true);
            echo "\" method=\"post\" class=\"form-horizontal game_form\" id=\"add_user_form\">
\t\t\t";
        }
        // line 15
...
\t\t\t\t\t";
        ...
        echo "
                    ";
        // line 17
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "practice"), 'row');
        echo "
                    ";
        // line 18
        ...
        echo "
                    ";
        // line 20
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "home_team"), 'row');
        echo "
                    ";
        // line 21
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "visiting_team"), 'row');
        echo "
                    ";
        // line 22
...
\t\t\t\t\t";
        ...
        // line 26
        echo $this->env->getExtension('routing')->getPath("schedule_index");
        echo "\">Back</a>
\t\t\t\t</div>
\t\t\t\t";
        // line 28
...
\t";
    ...
    {
        return "LjmsAdminBundle:Schedule:add.html.twig";
    }
