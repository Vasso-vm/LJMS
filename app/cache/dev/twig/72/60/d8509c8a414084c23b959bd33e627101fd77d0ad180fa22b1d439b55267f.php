...
class __TwigTemplate_7260d8509c8a414084c23b959bd33e627101fd77d0ad180fa22b1d439b55267f extends Twig_Template
{
...
\t\t\t";
        ...
        if (($this->getContext($context, "method") == "add")) {
            // line 11
            echo "\t\t\t\t<form action=\"";
            echo $this->env->getExtension('routing')->getPath("team_add");
            echo "\" method=\"post\" class=\"form-horizontal player_form\" id=\"add_user_form\">
\t\t\t";
        } else {
            // line 13
            echo "\t\t\t\t<form action=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("team_edit", array("id" => $this->getContext($context, "edit_id"))), "html", null, true);
            echo "\" method=\"post\" class=\"form-horizontal player_form\" id=\"add_user_form\">
\t\t\t\t
\t\t\t";
        }
...
\t\t\t\t\t";
        // line 21
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "traveling"), 'row');
        echo "
\t\t\t\t</fieldset>
...
\t";
    ...
    {
        return "LjmsAdminBundle:Team:add.html.twig";
    }
